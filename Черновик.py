...
class Gun:
    ...
    def draw(self):
        ...
        if self.f2_power <= 10:
            ...
            self.color = RED
        pygame.draw.polygon(screen, self.color, [[20 - 6 * math.sin(self.an), 500 + 6 * math.cos(self.an)], [20, 500], [20 + 1.3 * l * math.cos(self.an), 500 + 1.3 * l * math.sin(self.an)], [20 + 1.3 * l * math.cos(self.an) - 6 * math.sin(self.an), 500 + 1.3 * l * math.sin(self.an) + 6 * math.cos(self.an)]])
